    ...
    <div class="col-md-12 ">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <?=form_open_multipart('gallery/edit/'.$gallery->id, array('class' => 'form-horizontal'))?>
                    <div class="form-body">
                        
                        <div class="form-group ">
                            <label class="control-label col-md-3">Edit Gallery</label>
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail"  style="width: 400px; height: 400px;"
                                        <img src="uploads/gallery/<?=$gallery->name?>" alt=""/>
                                    </div>
                                    <div class="fileinput-preview fileinput-exists thumbnail" data-trigger="fileinput"  style="width: 400px; height: 400px;">
