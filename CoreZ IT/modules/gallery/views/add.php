    ...
    <div class="col-md-12 ">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <?=form_open_multipart('gallery/add', array('class' => 'form-horizontal'))?>
                    <div class="form-body">
                        <div class="form-group ">
                            <label class="control-label col-md-3">Add Slider</label>
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail"  style="width: 400px; height: 400px;">
                                        <img src="<?='assets/frontend/img/gal3.jpg'?>" alt=""/>
                                    </div>
