    ...
    <div class="col-md-12 ">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <?=form_open_multipart('client/edit/'.$client->id, array('class' => 'form-horizontal'))?>
                    <div class="form-body">
                        <div class="form-group ">
                            <label class="control-label col-md-3">Edit Client</label>
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 100px; height: 30px;">
                                        <img src="<?='uploads/client/'.$client->logo?>" alt=""/>
                                    </div>
